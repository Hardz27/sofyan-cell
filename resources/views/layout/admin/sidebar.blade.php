            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="index.html">
                        ...
                        <spa class="side-menu__label">Dashboard</span>
                    </a>
                </li>
                <li class="sub-category">
                    <h3>Admin Menu</h3>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('manage-user') }}">
                        <i class="side-menu__icon fe fe-users"></i>
                        <spa class="side-menu__label">Manage User</span>
                    </a>
                </li>
                <li class="slide">
